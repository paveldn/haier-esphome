...
We will now focus solely on hOn. Our current interest lies in the packet type and data. Typically, requests to the air conditioner use an odd packet type, and responses use an even type:
